...
# Load the dataset
df = pd.read_csv('MFE_USF2__output.csv')
...
average_mapping = pd.Series(df_unique.average.values, index=df_unique.MFE_category).to_dict()
...
df.to_csv('mapped_MFE_USF2.csv', index=False)
